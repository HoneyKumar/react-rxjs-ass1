...
class Home extends React.Component<State,Props>{
    ...
    handleChange = (e:any)=>{
        ...
        if(selectedVal === ''){
            ...
            messageStream.next('Please Select a Country');
        }
        ...
        return(
            ...
            {this.state.error === true &&
                ...
                <div className="main">
                    ...
                    <select className="select_country" value={this.state.currentSelectedValue} onChange={this.handleChange}>
                ...
                <div className="row">
                    <div className="previous_selected">
                        <h3>Previous Selected</h3>
                        {this.state.previousSelectedValue !== '' && 
                            <div>{this.state.previousSelectedValue}</div>
                        }
                        
                    </div>
                    <div className="current_selected">
                        <h3>Current Selected</h3>
                     <div>{this.state.currentSelectedValue}</div>

                    </div>
                    <div className="all_selected">
                        <h3>All Selected</h3>
                        <ul className="all_selected_items">{this.renderList(this.state.allSelectedValue)}</ul>
                    </div>
                </div>
